<template>
    <view>
        <view class="list-cell" hover-class="uni-list-cell-hover" @click="downfile(data)">
            ...
            <view class="media-list" v-if="data.filename">
                <view class="">
                 <text class="uni-icon uni-icon-download" style="color:#FF0000;font-size:40upx">{{data.filename}}.{{data.ext}}(G400)</text>
                </view>
							...
							success: (res) => {
								var data=res.data
								  if (data.code=='200') {
										  ...
										  uni.navigateTo({
										url: '/pages/user/web?zurl='+ysv8set.lang+'.ysv8.com/a/'+e.id+'.html'+'&url='+data['info']
							})	
